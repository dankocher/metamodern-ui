...
var MetRectangleIconBtn = function (_a) {
    ...
    var stateStyle = classNames$4(styles$8.rectangleIconBtn + " " + className, (_b = {},
        ...
        _b));
    return (React__default.createElement(Button$1, { role: "button", style: style, onClick: onClickHandler, type: type, className: stateStyle, borderColor: borderColor, bgColor: bgColor, hoverColor: hoverColor, defaultIconColor: defaultIconColor }, icon));
};
