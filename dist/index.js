...
var MetCircleIconBtn = function (_a) {
    ...
    return (React__default['default'].createElement(Button$2, { role: "button", size: size, style: style, onClick: onClick, className: styles$a.squareBtn + " " + className, bgColor: bgColor, hoverColor: hoverColor, defaultIconColor: defaultIconColor }, icon));
};
...
var MetPromptInfo = function (_a) {
    ...
    return (React__default['default'].createElement(Container$5, { ref: wrapperRef, style: style, className: styles$9.container + " " + className + " " + fontClass },
        React__default['default'].createElement(MetCircleIconBtn, { onClick: onClick, size: size, bgColor: bgColor, defaultIconColor: defaultIconColor, hoverColor: hoverColor, icon: icon }),
...
var MetSelect = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, { ref: wrapperRef, style: style, className: styles$7.container + " " + className, borderColor: borderColor, selectedColor: selectedColor, hoverColor: hoverColor, placeholderColor: placeholderColor, isSelected: selection.length !== 0, isOpen: isOpen },
        React__default['default'].createElement("div", { onKeyPress: function () { return toggle(); }, onClick: function () { return toggle(); } },
...
var MetTagInput = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, { style: style, className: stateStyle + " " + className, hoverFontColor: hoverFontColor, defaultColor: defaultColor, hoverCheckboxColor: hoverCheckboxColor, focusColor: focusColor, isFocused: isFocused },
        ...
        React__default['default'].createElement("div", { className: styles$3.container__content, onClick: openInput },
            ...
            React__default['default'].createElement("input", { onFocus: focusHandel, className: fontClass, value: value, onChange: onChange, onBlur: onBlurHandler })),
        React__default['default'].createElement("div", { className: styles$3.container__close },
            React__default['default'].createElement(MetCircleIconBtn, { onClick: function () { }, size: exports.Size.sm }))));
};
...
var MetTextField = function (_a) {
    ...
    return (React__default['default'].createElement(Container$1, { className: styles$2.container + " " + className, defaultColor: defaultColor, hoverColor: hoverColor, focusColor: focusColor, errorColor: errorColor, successColor: successColor, containerMessage: containerMessage },
        ...
        React__default['default'].createElement("div", { className: styles$2.inputContainer },
            React__default['default'].createElement("input", { style: style, className: stateStyle + " " + inputFontClass, value: value, onChange: onChange, onBlur: onBlur, placeholder: placeholder, disabled: isDisabled }),
...
var MetToggle = function (_a) {
    ...
    return (React__default['default'].createElement("label", { style: style, className: styles.toggleSwitch + " " + className },
        React__default['default'].createElement(Input, { type: "checkbox", checked: isChecked, onChange: function () { return onChange(); }, disabled: isDisabled, thumbOnColor: thumbOnColor }),
