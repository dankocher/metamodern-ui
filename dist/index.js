...
var MetRectangleIconBtn = function (_a) {
    ...
    return (React__default['default'].createElement(Button$1, { role: "button", style: style, onClick: onClickHandler, isDisabled: isDisabled, type: type, className: styles$8.rectangleIconBtn + " " + className + " " + (isDisabled ? styles$8.disabled : ""), borderColor: borderColor, bgColor: bgColor, hoverColor: hoverColor, defaultIconColor: defaultIconColor }, icon));
};
    ...
    return (React__default['default'].createElement(Container$4, { ref: wrapperRef, style: style, className: styles$7.container + " " + className, borderColor: borderColor, selectedColor: selectedColor, hoverColor: hoverColor, isDisabled: isDisabled, placeholderColor: placeholderColor, isSelected: selection.length !== 0, isOpen: isOpen },
        ...
        React__default['default'].createElement("div", { className: "" + styles$7.container__field },
            React__default['default'].createElement("div", { onClick: function () { return toggle(); } },
                ...
                icon),
            React__default['default'].createElement("ul", null, items.map(function (item) { return (React__default['default'].createElement("li", { key: item.id, onClick: function () { return handleOnClick(item); }, className: isItemInSelection(item) && styles$7.selected },
