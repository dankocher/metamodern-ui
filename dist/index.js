...
var InlineSVG = /** @class */ (function (_super) {
    ...
    InlineSVG.prototype.render = function () {
        ...
        if (element) {
            return React__namespace.cloneElement(element, __assign({ ref: innerRef }, elementProps));
        }
...
var MetIcon = function (_a) {
    ...
    return (React__default['default'].createElement(StyledSVG, { style: style, className: className, color: color, hoverColor: hoverColor, src: icons[name], width: size, height: size }));
};
...
var MetRectangleIconBtn = function (_a) {
    ...
    var buttonStyle = classNames$4(styles$8.rectangleIconBtn, (_b = {},
        ...
        _b));
    return (React__default['default'].createElement(Button$1, { role: "button", style: style, onClick: onClickHandler, type: type, className: buttonStyle, borderColor: borderColor, bgColor: bgColor, hoverColor: hoverColor, defaultIconColor: defaultIconColor }, icon));
};
...
var MetTextField = function (_a) {
    ...
    var containerMessage = classNames$1(styles$2.container_message, (_c = {},
        ...
        _c));
    return (React__default['default'].createElement(Container$1, { className: styles$2.container + " " + className, defaultColor: defaultColor, hoverColor: hoverColor, focusColor: focusColor, errorColor: errorColor, successColor: successColor },
...
var MetTextArea = function (_a) {
    ...
    return (React__default['default'].createElement(Container, { className: styles$1.container + " " + className, defaultColor: defaultColor, hoverColor: hoverColor, focusColor: focusColor, errorColor: errorColor, successColor: successColor, style: {
        ...
        React__default['default'].createElement("textarea", __assign$2({}, args, { ref: textAreaRef, rows: rowsMins, style: {
